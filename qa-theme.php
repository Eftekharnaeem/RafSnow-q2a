 ...
 * @since Eno 1.0
 * @version 1.4
 * @author Ashraf <https://www.enolez.com>
 * @copyright (c) 2019, Q2A enolez
 * @license http://www.enolez
 */
class qa_html_theme extends qa_html_theme_base
{
	protected $theme = 'enobyas';
	...
	{
		$jsUrl = $this->rooturl . $this->js_dir . '/enobyas-core.js?' . QA_VERSION;
	...
	public function attribution()
	{
		...
		$this->output(
			...
			'Enobyas Theme by <a href="http://www.enolez.com/User/Md.Ashraf+Uddin+Khan">Ashraf</a>',
			'</div>'
		);
		parent::attribution();
	}
